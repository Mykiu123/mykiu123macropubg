...
recoil_table["akm"] = {
    ...
    speed = 120,
    maxbullets = 40,
    holdbreathtimes = akmbx,
    fullholdbreathtimes = akmalbx,
    holdsquattimes = akmdx,
    fullholdsquattimes = akmaldx,
    holdsquattimes4x = akm4xdx,
    fullholdsquattimes4x = akmal4xdx,
}
...
recoil_table["m762"] = {
    ...
    speed = 100,
    maxbullets = 40,
    holdbreathtimes = m762bx,
    fullholdbreathtimes = m762albx,
    holdsquattimes = m762dx,
    fullholdsquattimes = m762aldx,
    holdsquattimes4x = m7624xdx,
    fullholdsquattimes4x = m762al4xdx,
}
...
recoil_table["groza"] = {
    ...
    speed = 80,
    maxbullets = 40,
    holdbreathtimes = grozabx,
    fullholdbreathtimes = grozaalbx,
    holdsquattimes = grozadx,
    fullholdsquattimes = grozaaldx,
    holdsquattimes4x = groza4xdx,
    fullholdsquattimes4x = grozaal4xdx,
}
...
recoil_table["m16a4"] = {
    ...
    maxbullets = 40,
    clickspeed = 40,
    holdbreathtimes = m16a4bx,
    fullholdbreathtimes = m16a4albx,
    holdsquattimes = m16a4dx,
    fullholdsquattimes = m16a4aldx,
    holdsquattimes4x = m16a44xdx,
    fullholdsquattimes4x = m16a4al4xdx,
}
...
recoil_table["m416"] = {
    ...
    speed = 80,
    maxbullets = 40,
    holdbreathtimes = m416bx,
    fullholdbreathtimes = m416albx,
    holdsquattimes = m416dx,
    fullholdsquattimes = m416aldx,
    holdsquattimes4x = m4164xdx,
    fullholdsquattimes4x = m416al4xdx,
}
...
recoil_table["scarl"] = {
    ...
    speed = 90,
    maxbullets = 40,
    holdbreathtimes = scarlbx,
    fullholdbreathtimes = scarlalbx,
    holdsquattimes = scarldx,
    fullholdsquattimes = scarlaldx,
    holdsquattimes4x = scarl4xdx,
    fullholdsquattimes4x = scarlal4xdx,
}
...
recoil_table["aug"] = {
    ...
    speed = 90,
    maxbullets = 40,
    holdbreathtimes = augbx,
    fullholdbreathtimes = augalbx,
    holdsquattimes = augdx,
    fullholdsquattimes = augaldx,
    holdsquattimes4x = aug4xdx,
    fullholdsquattimes4x = augal4xdx,
}
...
recoil_table["qbz"] = {
    ...
    speed = 90,
    maxbullets = 40,
    holdbreathtimes = qbzbx,
    fullholdbreathtimes = qbzalbx,
    holdsquattimes = qbzdx,
    fullholdsquattimes = qbzaldx,
    holdsquattimes4x = qbz4xdx,
    fullholdsquattimes4x = qbzal4xdx,
}
...
recoil_table["g36c"] = {
    ...
    speed = 80,
    maxbullets = 40,
    holdbreathtimes = g36cbx,
    fullholdbreathtimes = g36calbx,
    holdsquattimes = g36cdx,
    fullholdsquattimes = g36caldx,
    holdsquattimes4x = g36c4xdx,
    fullholdsquattimes4x = g36cal4xdx,
}

recoil_table["ump9"] = {

    basic = { 30, 31, 32, 34, 35, 35, 35, 36, 42, 38, 39, 42, 42, 43, 43, 43, 43, 42, 44, 42, 43, 40, 42, 44, 42, 42, 42,
        42, 42 },

    basictimes = ump9,

    full = { 30, 31, 32, 34, 35, 35, 35, 36, 42, 38, 39, 42, 42, 41, 41, 41, 41, 42, 44, 42, 43, 40, 41, 44, 40, 40, 41,
        42, 43 },

    fulltimes = ump9al,

    quadruple = { 30, 31, 32, 34, 37, 35, 35, 36, 42, 38, 39, 42, 42, 41, 41, 41, 41, 42, 44, 42, 43, 40, 41, 44, 40, 40,
        41, 42, 43 },

    quadrupletimes = ump94x,

    fullof4x = { 30, 31, 32, 34, 37, 35, 35, 36, 42, 38, 39, 42, 42, 41, 41, 41, 41, 42, 44, 42, 43, 40, 41, 44, 40, 40,
        41, 42, 43 },
    ...
    speed = 80,
    maxbullets = 40,
    holdbreathtimes = ump9bx,
    fullholdbreathtimes = ump9albx,
    holdsquattimes = ump9dx,
    fullholdsquattimes = ump9aldx,
    holdsquattimes4x = ump94xdx,
    fullholdsquattimes4x = ump9al4xdx,
}
...
recoil_table["pp19"] = {
    ...
    speed = 110,
    maxbullets = 55,
    holdbreathtimes = pp19bx,
    fullholdbreathtimes = pp19albx,
    holdsquattimes = pp19dx,
    fullholdsquattimes = pp19aldx,
    holdsquattimes4x = pp194xdx,
    fullholdsquattimes4x = pp19al4xdx,
}
...
recoil_table["vss"] = {
    ...
    quadruple = { 30, 25, 35, 45, 58, 58, 80, 85, 80, 90, 90, 90, 90, 90, 90, 90, 90, 108, 108, 108, 108, 108, 108, 108,
        108 },

    quadrupletimes = vss4x,

    fullof4x = { 30, 25, 35, 45, 58, 58, 80, 85, 80, 90, 90, 90, 90, 90, 90, 90, 90, 105, 105, 105, 105, 105, 105, 105,
        105 },
    ...
    speed = 40,
    maxbullets = 40,
    holdbreathtimes = vssbx,
    fullholdbreathtimes = vssalbx,
    holdsquattimes = vssdx,
    fullholdsquattimes = vssaldx,
    holdsquattimes4x = vss4xdx,
    fullholdsquattimes4x = vssal4xdx,
}
...
recoil_table["liandian"] = {
    ...
    clickspeed = 40,
    holdbreathtimes = 1,
    fullholdbreathtimes = 1,
    holdsquattimes = 1,
    fullholdsquattimes = 1,
    holdsquattimes4x = 1,
    fullholdsquattimes4x = 1,
}
--------------------------------------------------------------------------
----------------          function          ------------------------------
--------------------------------------------------------------------------
...
function OnEvent(event, arg)
    ...
    function TS()
        OutputLogMessage(" 当前武器: " .. current_weapon .. " | PING : " .. Ping .. " | 模式: " ..
            recoil_mode() .. "\n")
